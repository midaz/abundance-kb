...
export const policyResources: PolicyResource[] = [
  ...
  },
  {
    "id": 2,
    "title": "Policy Gauge",
    "description": "This tool models how adjusting policy factors like density and parking requirements impact the number of units produced and tax revenue generated.",
    "type": "simulator",
    "region": "west",
    "policyType": "housing",
    "policyArea": "landuse",
  ...
  },
  {
    ...
    "description": "A catalog of 208 Land use ballot measures that Californians have voted on over the years. Ballot measures are broken into categories and then analyzed for their wider impact on adding housing stock.",
    "type": "brief",
    "region": "west",
    "policyType": "housing",
  ...
  },
  {
    ...
    "description": "Interactive excercise that helps visualize and explain building costs for multi-family, affordable housing.",
    "type": "simulator",
    "region": "national",
    "policyType": "housing",
    "policyArea": "financing",
  ...
  },
  {
    ...
    "description": "A comparison of 10 local Housing Trust Fund implementations, featuring different sizes and politial alignments.",
    "type": "brief",
    "region": "national",
    "policyType": "housing",
    "policyArea": "financing",
  ...
  },
  {
    ...
    "description": "Questionaire/assessment that identifies the strengths of your local housing plan.",
    "type": "assessment",
    "region": "national",
    "policyType": "housing",
    "policyArea": "landuse",
  ...
  },
  {
    ...
    "description": "Visually compare housing needs in your area to national aggregate of demographic data, economic data, property & stock data, subsidy data. Powered by PolicyMap.",
    "type": "assessment",
    "region": "national",
    "policyType": "housing",
    "policyArea": "landuse",
  ...
  },
  {
    ...
    "description": "Step by step guidance around planning a strategy, analyzing data, crafting policy, finding funding, making adjustments, and bridging policy sectors.",
    "type": "guide",
    "region": "national",
    "policyType": "housing",
    "policyArea": "landuse",
  ...
  },
  {
    ...
    "description": "A menu of funding sources local governments can employ to increase or preserve affordable housing.",
    "type": "brief",
    "region": "national",
    "policyType": "housing",
    "policyArea": "financing",
  ...
  },
  {
    ...
    "description": "Map of census tracts that shows eviction risk percentiles, ranking neighborhoods relative to others across the broader state",
    "type": "map",
    "region": "national",
    "policyType": "housing",
    "policyArea": "rental",
  ...
  },
  {
    ...
    "description": "Walk through of proposed policies including increased density, adding missing middle, doubling housing near transit, and legalizing multi-family housing in commercial or retail zones. The tool predicts how many units of housing would result from enacting any of the above policies.",
    "type": "simulator",
    "region": "west",
    "policyType": "housing",
    "policyArea": "landuse",
  ...
  },
  {
    ...
    "description": "3 pager on highlights from the Joint Center for Housing Studies' annual report covering trends in housing cost burden, population demographics, and rates of homelessness.",
    "type": "brief",
    "region": "national",
    "policyType": "housing",
    "policyArea": "rental",
